...
The course will be conducted remotely via Zoom using the course link at the top of the page. This class will be synchronous --- instruction will take place at the scheduled time, and I do not plan to record the classes. If you are having a technical difficulty (wifi/power outage/etc.) and lose access to the class (or can't get in), please notify US SOMEHOW. You are responsible for all class material, but we will do our best to get you caught up.
