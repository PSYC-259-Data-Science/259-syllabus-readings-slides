...
## `r advdate(wed, 2)`: The First Topic Where We Read John Vasquez

```{r, echo = FALSE, results="asis"} 
bib[author = "vasquez"]
``` 

##  `r advdate(wed, 3)`: Read the Nos. 90-97 Items in My Bib
...
##  `r advdate(wed, 4)`: Read Bib Item No. 120
...
##  `r advdate(wed, 5)`: The Fourth Topic with Bib Item No. 510

```{r, echo = FALSE, results="asis", eval=F} 
bib[510]
``` 

##  `r advdate(wed, 6)`: Keep
##  `r advdate(wed, 7)`: Going
##  `r advdate(wed, 8)`: Down

##  `r advdate(wed, 9)`: the

##  `r advdate(wed, 10)`: Line
