...
*SOFTWARE SETUP:* Follow the directions [here](https://github.com/PSYC-259-Data-Science/259-syllabus/blob/master/software_setup.md) to setup R, RStudio, git, and Github. Afterwards, read and follow along with the [Github beginner guide](https://guides.github.com/activities/hello-world/).
...
- *SKILLS:* Iteration (map, for loops), writing basic functions
...
- *SKILLS:* Basic visualizations, broom
...
##  `r advdate(wed, 6)`: Reuse Part 1: Data Sharing, Archiving, and Documentation
...
##  `r advdate(wed, 7)`: Reuse Part 2: Encapsulation and Writing Functions
